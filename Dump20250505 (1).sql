...
--
-- Host: 127.0.0.1    Database: bdpinki
-- ------------------------------------------------------
...
--
-- Table structure for table `auditoria_empleado`
--
...
CREATE TABLE `auditoria_empleado` (
  `idAudEmpleado` int NOT NULL AUTO_INCREMENT,
  `columna` varchar(45) DEFAULT NULL,
  `fecha` varchar(45) DEFAULT NULL,
  `usuario` varchar(45) DEFAULT NULL,
  `valorAntes` varchar(45) DEFAULT NULL,
  `valorDespues` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idAudEmpleado`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `auditoria_empleado`
--

LOCK TABLES `auditoria_empleado` WRITE;
...
CREATE TABLE `empleado` (
  ...
  KEY `fk_empleado_estado_civil_idx` (`idEstCivil`),
...
INSERT INTO `estado` VALUES (1,'activo'),(2,'inactivo'),(3,'pendiente'),(4,'completado');
...
CREATE TABLE `modalidad` (
  ...
  `nomModalidad` varchar(20) DEFAULT NULL,
...
CREATE TABLE `pago` (
  ...
  `esgratificacion` tinyint DEFAULT NULL,
  `fechacreacion` datetime DEFAULT NULL,
  PRIMARY KEY (`idPago`),
  KEY `fk_pago_contrato_idx` (`idContrato`),
  KEY `fk_pagp_banco_idx` (`idBanco`),
  KEY `fk_pago_estado_idx` (`estado`),
  CONSTRAINT `fk_pago_banco` FOREIGN KEY (`idBanco`) REFERENCES `banco` (`idBanco`),
...
INSERT INTO `sessions` VALUES ('Jf5gRvFXSHUUexXDLGNpKnywRKZ4Ep0rKK7mf4eA',2,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Safari/537.36','',1746486960);
...
INSERT INTO `users` VALUES (1,'dan','dan@gmail.com',NULL,'$2y$12$T2H8EiYgc48HcGrPimdM0uD//9x2Y2vulS/3io..7ndP86aVwJOq6',NULL,'2025-05-06 01:47:20','2025-05-06 01:47:20'),(2,'MAFER','nose@gmail.com',NULL,'$2y$12$TOwgq3Y4VZLW.EwAiaBMNuaOejBps3Pre0H/xf0TW/oZg0X9UIZja',NULL,'2025-05-06 03:25:30','2025-05-06 03:25:30');
...
CREATE TABLE `usuario` (
  ...
  `nomUsuario` varchar(25) DEFAULT NULL,
  `nombres` varchar(25) DEFAULT NULL,
  `apePaterno` varchar(25) DEFAULT NULL,
  `apeMaterno` varchar(25) DEFAULT NULL,
  `password` varchar(8) DEFAULT NULL,
  `type` enum('ADMIN','CONSULTOR') DEFAULT NULL,
...
-- Dump completed on 2025-05-05 23:11:59
